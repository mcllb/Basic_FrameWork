...
public class PermissionAddParam extends BaseAddParam {
     ...
     * 权限类型（字典： 0目录 1菜单 2按钮）
     */
    @NotNull(message = "权限类型不能为空，请检查参数permissionType")
     ...
     * 是否外链（字典: 1内链 2外链）
     */
    @EnumDictValidator(value = PermissionOpenTypeEnum.class,message = "是否外链不在正确的枚举中，请检查参数openType")
