...
public class WebUtil extends org.springframework.web.util.WebUtils {
	...
	public static boolean isBody(HandlerMethod handlerMethod) {
		ResponseBody responseBody = AnnotationUtil.getAnnotation(handlerMethod, ResponseBody.class);
	...
	public static String getIP(HttpServletRequest request) {
		...
		if (cn.hutool.core.util.StrUtil.isBlank(ip) || UN_KNOWN.equalsIgnoreCase(ip)) {
		...
		return cn.hutool.core.util.StrUtil.isBlank(ip) ? null : ip.split(",")[0];
	}
	...
	public static String getRequestStr(HttpServletRequest request) throws IOException {
		...
		if (cn.hutool.core.util.StrUtil.isNotBlank(queryString)) {
	...
	public static String getRequestStr(HttpServletRequest request, byte[] buffer) throws IOException {
		...
		if (cn.hutool.core.util.StrUtil.isBlank(str)) {
			...
			str = cn.hutool.core.util.StrUtil.removeSuffix(sb.toString(), "&");
		}
